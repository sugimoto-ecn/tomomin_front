...
import { SIDE_CONTENTS } from '../../app.config'

const drawerWidth = 240;



console.log(SIDE_CONTENTS)
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {SIDE_CONTENTS.map((item, index) => (
            <ListItem button key={index} className={`${location.pathname == `/dashboard${item.path}` && styles.activeNav}`} onClick={() => linkTo(item.path)}>
              <ListItemIcon>
