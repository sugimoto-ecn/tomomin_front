...
const SideBar = () => {
  ...
  　　　　　　　　　　　　      <ul class="nav flex-column">
                                <li class="nav-item" className={`${styles.activeNav}`} onClick={() => linkTo("/sleeps")}>
                                ...
                                <li class="nav-item pt-4" onClick={() => linkTo("/time-setting")}>
                                ...
                                <li class="nav-item pt-4" onClick={() => linkTo("/user-setting")}>
                                    <span className={`${styles.pointer} nav-link  text-dark`}>
                                ...
                                <li class="nav-item pt-4" onClick={() => linkTo("/follows")}>
                                    <span className={`${styles.pointer} nav-link  text-dark`}>
